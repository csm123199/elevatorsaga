...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"HYNy":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.requireUserCountWithinTime = requireUserCountWithinTime;
exports.requireUserCountWithMaxWaitTime = requireUserCountWithMaxWaitTime;
exports.requireUserCountWithinTimeWithMaxWaitTime = requireUserCountWithinTimeWithMaxWaitTime;
exports.requireUserCountWithinMoves = requireUserCountWithinMoves;
exports.requireDemo = requireDemo;
...
},{}],"Sc4J":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.route = exports.render = exports.observable = void 0;
...
},{"jquery":"HlZQ"}],"qotB":[function(require,module,exports) {
"use strict";
...
var _riotEs = require("./libs/riot.es6.js");
...
class Observable {
  constructor() {
    ...
    (0, _riotEs.observable)(this); // backup observable functions to seperate method
  ...
  on(event, callback) {
    if (LOG_EVENTS && !DEBUG_FILTER_BLACKLIST.some(v => event == v)) console.log(`[DEBUG] registering event handler on ${this.constructor.name}: ${event}`);
  ...
  trigger(event, ...args) {
    if (LOG_EVENTS && !DEBUG_FILTER_BLACKLIST.some(v => event == v)) console.log(`[DEBUG] event triggered ${this.constructor.name}: ${event}(${args.map(v => v.toString()).join()})`);
...
exports.Observable = Observable;
},{"./libs/riot.es6.js":"Sc4J"}],"TLTV":[function(require,module,exports) {
"use strict";
...
exports.powInterpolate = powInterpolate;
exports.coolInterpolate = coolInterpolate;
exports.Movable = exports.DEFAULT_INTERPOLATOR = void 0;
...
let DEFAULT_INTERPOLATOR = coolInterpolate;
exports.DEFAULT_INTERPOLATOR = DEFAULT_INTERPOLATOR;
const _tmpPosStorage = [0, 0];

class Movable extends _observable.Observable {
  constructor() {
    super();
    this.movable = this;
    this.x = 0.0;
...
},{"./observable":"qotB"}],"AXF9":[function(require,module,exports) {
"use strict";
...
class User extends _movable.Movable {
  ...
  handleExit(floorNum, elevator) {
    if (elevator.currentFloor === this.destinationFloor) {
      ...
      this.moveToOverTime(destination, null, 1 + Math.random() * 0.5, _movable.linearInterpolate, lastMove);
...
exports.User = User;
},{"./movable":"TLTV"}],"v5cZ":[function(require,module,exports) {
"use strict";
...
exports.createFrameRequester = createFrameRequester;
exports.getCodeObjFromCode = getCodeObjFromCode;
exports.USERCODE_MODULE_NAME = void 0;
const USERCODE_MODULE_NAME = 'UserCode';
exports.USERCODE_MODULE_NAME = USERCODE_MODULE_NAME;

function random(max, inclusive = true) {
  return Math.floor(Math.random() * (max + (inclusive ? 1 : 0)));
}

function randomRange(min, max, inclusive = true) {
...
function objectFactory(names, transform) {
...
function createBoolPassthroughFunction(host, owner, prop) {
...
},{}],"kKfC":[function(require,module,exports) {
"use strict";
...
class Elevator extends _movable.Movable {
  constructor(speedFloorsPerSec, floorCount, floorHeight, maxUsers) {
    ...
    this.velocityY = 0.0; // isMoving flag is needed when going to same floor again - need to re-raise events
  ...
  pressFloorButton(floorNumber) {
    var prev;
    floorNumber = (0, _base.limitNumber)(floorNumber, 0, this.floorCount - 1);
  ...
  updateElevatorMovement(deltaTime) {
    ...
    this.velocityY = (0, _base.limitNumber)(this.velocityY, -this.MAXSPEED, this.MAXSPEED); // Move elevator
    ...
    if (destinationDiff !== 0.0) {
      if (directionSign === velocitySign) {
        ...
        var distanceNeededToStop = (0, _base.distanceNeededToAchieveSpeed)(this.velocityY, 0.0, this.DECELERATION);
        ...
        if (distanceNeededToStop * 1.05 < -Math.abs(destinationDiff)) {
          ...
          var requiredDeceleration = (0, _base.accelerationNeededToAchieveChangeDistance)(this.velocityY, 0.0, destinationDiff);
        ...
        this.velocityY -= velocitySign * this.DECELERATION * deltaTime; // Make sure we don't change direction within this time step - let standstill logic handle it
  ...
  handleDestinationArrival() {
    ...
    if (this.isOnAFloor()) {
      ...
      this.trigger("stopped_at_floor", this.currentFloor); // Need to allow users to get off first, so that new ones
  ...
  getFirstPressedFloor() {
    (0, _base.deprecationWarning)("getFirstPressedFloor");
  ...
  isOnAFloor() {
    return (0, _base.epsilonEquals)(this.getExactCurrentFloor(), this.getRoundedCurrentFloor());
  }
  ...
  handleNewState() {
    ...
    if (futureTruncFloorIfStopped !== this.previousTruncFutureFloorIfStopped) {
      ...
      let floorBeingPassed = Math.round(this.getExactFutureFloorIfStopped()); // Never emit passing_floor event for the destination floor
...
},{"./base":"v5cZ","./movable":"TLTV"}],"Jk2G":[function(require,module,exports) {
"use strict";
...
class Floor extends _observable.Observable {
...
exports.Floor = Floor;
},{"./observable":"qotB"}],"Z3CV":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ElevatorInterface = void 0;
...
class ElevatorInterface extends _observable.Observable {
  constructor(elevator, floorCount, errorHandler) {
    super();
    this.destinationQueue = [];

    this.goingUpIndicator = v => (0, _base.createBoolPassthroughFunction)(this, this.elevator, "goingUpIndicator")(v);

    this.goingDownIndicator = v => (0, _base.createBoolPassthroughFunction)(this, this.elevator, "goingDownIndicator")(v);

    this.elevator = elevator;
    this.floorCount = floorCount;
    this.errorHandler = errorHandler;
    elevator.on("stopped", position => {
      if (this.destinationQueue.length && (0, _base.epsilonEquals)(this.destinationQueue[0], position)) {
  ...
  goToFloor(floorNum, forceNow) {
    floorNum = (0, _base.limitNumber)(Number(floorNum), 0, this.floorCount - 1); // Auto-prevent immediately duplicate destinations

    if (this.destinationQueue.length > 0) {
      let adjacentElement = forceNow ? this.destinationQueue[0] : this.destinationDirection[this.destinationQueue.length - 1];

      if ((0, _base.epsilonEquals)(floorNum, adjacentElement)) {
        return;
      }
...
exports.ElevatorInterface = ElevatorInterface;
},{"./observable":"qotB","./base":"v5cZ"}],"XLY6":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.WorldController = exports.World = exports.WorldCreator = void 0;
...
class WorldCreator {
  createFloors(floorCount, floorHeight, errorHandler) {
    return new Array(floorCount).fill(undefined).map((_, i) => {
      ...
      return new _floor.Floor(i, yPos, errorHandler);
    });
  }
  ...
  createElevators(elevatorCount, floorCount, floorHeight, elevatorCapacities = [4]) {
    ...
    const elevators = new Array(elevatorCount).fill(undefined).map((_, i) => {
      const elevator = new _elevator.Elevator(2.6, floorCount, floorHeight, elevatorCapacities[i % elevatorCapacities.length]); // Move to right x position
  ...
  createRandomUser(spawnTime) {
    let weight = (0, _base.randomRange)(55, 100);
    let displayType;

    if ((0, _base.random)(40) === 0) {
      // Math.floor(Math.random()*5) === 0
      displayType = "child";
    } else {
      // Math.round(Math.random()) === 0
      displayType = (0, _base.random)(1) === 0 ? "female" : "male";
    }

    return new _user.User(weight, displayType, spawnTime);
  }

  spawnUserRandomly(spawnTime, floorCount, floorHeight, floors) {
    let user = this.createRandomUser(spawnTime);
    user.moveTo(105 + (0, _base.random)(40), 0);
    let currentFloor = (0, _base.random)(1) === 0 ? 0 : (0, _base.random)(floorCount, false);
    let destinationFloor;

    if (currentFloor === 0) {
      // Definitely going up
      destinationFloor = (0, _base.randomRange)(1, floorCount - 1);
    } else {
      // Usually going down, but sometimes not
      if ((0, _base.random)(10) === 0) {
        destinationFloor = (currentFloor + (0, _base.randomRange)(1, floorCount, false)) % floorCount;
      } else {
        destinationFloor = 0;
      }
    }
...
class World extends _observable.Observable {
  constructor(creator, options) {
    ...
    this.handleElevAvailability = elevator => {
      ...
      for (let floor of this.floors) {
        if (elevator.currentFloor === floor.level) floor.elevatorAvailable(elevator);
      }
    ...
    this.handleButtonRepressing = (eventName, floor) => {
      ...
      let offset = (0, _base.random)(this.elevators.length - 1);
    ...
    const {
      floorHeight,
      // Only needed to create floors
      floorCount,
      // Only needed to create floors
      elevatorCount,
      // Only needed to create elevators
      spawnRate,
      elevatorCapacities
    ...
    this.elevatorInterfaces = this.elevators.map(e => new _interfaces.ElevatorInterface(e, floorCount, this.handleUserCodeError)); // Bind them all together

    this.elevators.forEach(elevator => elevator.on("entrance_available", this.handleElevAvailability)); // This will cause elevators to "re-arrive" at floors if someone presses an
  ...
  registerUser(user) {
    ...
    user.updateDisplayPosition(true); //user.spawnTimestamp = this.elapsedTime;
  ...
  unWind() {
    ...
    [this.elevators, this.elevatorInterfaces, this.users, this.floors, [this]].flat().forEach(obj => obj.off('*'));
    this.elevators = [];
...
class WorldController extends _observable.Observable {
  constructor(dtMax) {
    super();
    this.dtMax = dtMax;
    this.timeScale = 1.0;
  ...
  start(world, codeObj, animationFrameRequester, autoStart) {
    ...
    let updater = t => {
      if (!this.isPaused && !world.challengeEnded && lastT !== null) {
        if (firstUpdate) {
          firstUpdate = false; // This logic prevents infite loops in usercode from breaking the page permanently - don't evaluate user code until game is unpaused.
...
},{"./base":"v5cZ","./user":"AXF9","./floor":"Jk2G","./elevator":"kKfC","./observable":"qotB","./interfaces":"Z3CV"}],"ONyr":[function(require,module,exports) {
"use strict";

var _challenges = require("../ts/challenges");

var _movable = require("../ts/movable");

var _user = require("../ts/user");

var _elevator = require("../ts/elevator");

var _world = require("../ts/world");

var _interfaces = require("../ts/interfaces");

var _base = require("../ts/base");
...
describe("Elevator Saga", function () {
  ...
  describe("Movable object", function () {
    ...
    it("gets new display position when parent is moved", function () {
      var mParent = new _movable.Movable();
      m.setParent(mParent);
  ...
  describe("World controller", function () {
    ...
    beforeEach(function () {
      controller = new _world.WorldController(DT_MAX);
      fakeWorld = {
        update: function (dt) {},
        init: function () {},
      ...
      frameRequester = (0, _base.createFrameRequester)(10.0);
  ...
  describe("Challenge requirements", function () {
    ...
    describe("requireUserCountWithinTime", function () {
      it("evaluates correctly", function () {
        var challengeReq = (0, _challenges.requireUserCountWithinTime)(10, 5.0);
    ...
    describe("requireUserCountWithMaxWaitTime", function () {
      it("evaluates correctly", function () {
        var challengeReq = (0, _challenges.requireUserCountWithMaxWaitTime)(10, 4.0);
        expect(challengeReq.evaluate(fakeWorld)).toBe(null);
    ...
    describe("requireUserCountWithinMoves", function () {
      it("evaluates correctly", function () {
        var challengeReq = (0, _challenges.requireUserCountWithinMoves)(10, 20);
        expect(challengeReq.evaluate(fakeWorld)).toBe(null);
    ...
    describe("requireUserCountWithinTimeWithMaxWaitTime", function () {
      it("evaluates correctly", function () {
        var challengeReq = (0, _challenges.requireUserCountWithinTimeWithMaxWaitTime)(10, 5.0, 4.0);
        expect(challengeReq.evaluate(fakeWorld)).toBe(null);
        fakeWorld.elapsedTime = 5.1;
        expect(challengeReq.evaluate(fakeWorld)).toBe(false);
        fakeWorld.transportedCounter = 11;
  ...
  describe("Elevator object", function () {
    ...
    var floorHeight = 44;
    beforeEach(function () {
      e = new _elevator.Elevator(1.5, floorCount, floorHeight);
    ...
    it("doesnt seem to overshoot when stopping at floors", function () {
      for (let updatesPerSecond = 60; updatesPerSecond < 120; updatesPerSecond += 2.32133) {
        ...
        timeForwarder(5.0, STEPSIZE, function (dt) {
          e.update(dt);
          e.updateElevatorMovement(dt); //@ts-ignore Not sure why toBeWithinRange isn't typed as valid - but not concerned since it works
  ...
  describe("API", function () {
    describe("Elevator interface", function () {
      ...
      beforeEach(function () {
        e = new _elevator.Elevator(1.5, 4, 40);
        e.setFloorPosition(0);
        elevInterface = new _interfaces.ElevatorInterface(e, 4, e => {
          throw e;
        });
      });
      ...
      it("normalizes load factor", function () {
        for (let i = 0; i < 20; i++) {
          let mockUser = {
            weight: (0, _base.randomRange)(55, 100)
          };
      ...
      it("doesnt raise unexpected events when told to stop when passing floor", function () {
        ...
        elevInterface.on("passing_floor", function (floorNum, direction) {
          passingFloorEventCount++; // We only expect to be passing floor 1, but it is possible and ok that several
...
},{"../ts/challenges":"HYNy","../ts/movable":"TLTV","../ts/user":"AXF9","../ts/elevator":"kKfC","../ts/world":"XLY6","../ts/interfaces":"Z3CV","../ts/base":"v5cZ"}]},{},["ONyr"], null)
//# sourceMappingURL=/tests.9ae253f7.js.map