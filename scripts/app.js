...
function getTemplates() {
    ...
    for (let templName of ['floor', 'elevator', 'elevatorbutton', 'user', 'challenge', 'feedback', 'codestatus']) {
...
class ElevatorSagaApp extends Observable {
    ...
    ;
    async startChallenge(challengeIndex, autoStart, params = {}) {
